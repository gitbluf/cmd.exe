 ...
 */
export function readFileSafe(filePath: string, encoding: BufferEncoding = "utf-8"): string | undefined {
  try {
 ...
 */
export function writeFileSafe(filePath: string, content: string, encoding: BufferEncoding = "utf-8"): boolean {
  try {
